...
class TestSignupView:
    ...
    def test_signup_successful(self, api_client, user_built):
        response = api_client.post(self.url, user_built, format="json")
    ...
    def test_signup_failed_with_incorrect_data(self, api_client):
        response = api_client.post(self.url, {}, format="json")
        assert response.status_code == 400
        assert response.json() != {}

    def test_signup_failed_with_existing_email(
        self, api_client, user_created, user_built
    ):
...
class TestLoginView:
    ...
    def test_login_successful(self, api_client, create_user_with):
        ...
        response = api_client.post(self.url, access_data, format="json")
    ...
    def test_login_failed_for_an_inactive_user(self, api_client, create_user_with):
...
class TestRefreshTokenView:
    ...
    def test_refresh_token_successful(self, api_client, create_user_with):
        user = create_user_with(password="password1234")
        access_data = {"email": user.email, "password": "password1234"}
    ...
    def test_refresh_token_failed_with_incorrect_data(self, api_client):
        response = api_client.post(self.url, {}, format="json")
    ...
    def test_refresh_token_failed_with_empty_token(self, api_client, refresh_token):
